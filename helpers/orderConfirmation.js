    ...
    <body>
        <div class='container'>
            <div class='wrapper'>
                ...
                <P>Thank you for shopping with TejashCreation we have received
                    your order and will get started on it right away.
                    Once your order has been processed and is on its
      ...
      <body>
        <div class="container" >
          <div class="firstContainer" style="box-shadow: 0 2px 2px -2px rgba(0,0,0,.5)">
            <h1 style="margin: 10px 0px" class="center">TejashCreation</h1>
